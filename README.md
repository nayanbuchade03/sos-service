...
In the today's world we can see a lot of crime and riots takes place. It becomes difficult for police officers to handle each and every operation with minute detail and management. SOS Service is a backend system designed to support two critical police operations: **Patrolling** and **Nakabandi/Bandobast**.  
